...
class CryptoManager {
    ...
    private fun getKey(): SecretKey {
        return try {
            ...
            // RECOVERY: If key is corrupted or inaccessible, delete and recreate
    ...
    private fun createKey(): SecretKey {
        return try {
            ...
            // Fallback for devices with hardware Keystore issues
            throw IllegalStateException("Failed to initialize security key: ${e.message}")
        }
    }
    ...
    internal fun getDecryptCipherForIv(iv: ByteArray): Cipher {
        return Cipher.getInstance(TRANSFORMATION).apply {
    ...
    companion object {
        private const val ALIAS = "mapplock_professional_key" // Updated alias
